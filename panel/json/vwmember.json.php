...
$q="
SELECT * FROM `vwmember` WHERE  (ifnull(nostok,'') like '%".$ns."%') and (nama like '%".$s."%' or noid like '%".$s."%' or kota like '%".$s."%' or propinsi like '%".$s."%') $sqld1 $sqld2 ".($o==""?"":("ORDER BY ".$o.($ot=="DESC"?" DESC ":" ASC ")))." ".($l==""?" LIMIT 1000":(" LIMIT ".$l));
//echo $q;
?>