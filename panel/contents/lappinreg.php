		...
		<form class="form-horizontal" name="lapdaftar" id="lapdaftar" method="post" onsubmit="return previewData()">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Laporan <strong>PIN PENDAFTARAN</strong> </h3>
								...
								<div class="form-group">
									...
									<div class="col-md-10">                                            
										<div class="input-group">
											...
											$sqlprd = "SELECT * FROM produk where publik=1 AND register=1 order by id ";
										...
										<span class="help-block">Jenis produk</span>
									</div>
								</div>
							</div>
...
<hr/>
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">Data<strong> PIN Pendaftaran</strong></h3>
				<ul class="panel-controls">
					<li><a href="#" class="panel-fullscreen"><span class="fa fa-expand"></span></a></li>
					<li><a href="#" class="panel-collapse"><span class="fa fa-angle-down"></span></a></li>
					<li><a href="#" class="panel-remove"><span class="fa fa-times"></span></a></li>
