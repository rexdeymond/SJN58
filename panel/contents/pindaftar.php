		...
		<form class="form-horizontal" name="pingenerate" id="pingenerate" method="post" onsubmit="return GeneratePin()">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><strong>Pin Generator </strong> Pendaftaran</h3>
...
<hr/>
	<div class="col-md-12">
		...
		<form class="form-horizontal" name="pinaktif" id="pinaktif" method="post" onsubmit="return AktifasiPin()">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><strong>Aktivasi Pin </strong> Pendaftaran</h3>
					<ul class="panel-controls">
						<li><a href="#" class="panel-fullscreen"><span class="fa fa-expand"></span></a></li>
						<li><a href="#" class="panel-collapse"><span class="fa fa-angle-down"></span></a></li>
						<li><a href="#" class="panel-remove"><span class="fa fa-times"></span></a></li>
				...
				<div class="panel-body">                                                                        
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="form-group">
									<label class="col-md-3 control-label">Jenis Pin</label>
									<div class="col-md-9">                                            
										<div class="input-group">
											...
											<!--input type="text" class="form-control" name="slctipe"/-->
										</div>                                            
										<span class="help-block">Pilih Tipe Pin Pendaftaran</span>
									</div>
								</div>
							</div>
...
<!--div class="col-md-12"-->
		<div class="col-md-6">
			...
			<form class="form-horizontal" name="pindeaktif"  id="pindeaktif" method="post" onsubmit="return DeAktifPin()">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title"><strong>De-Aktivasi Pin </strong> Pendaftaran</h3>
						<ul class="panel-controls">
							<li><a href="#" class="panel-fullscreen"><span class="fa fa-expand"></span></a></li>
							<li><a href="#" class="panel-collapse"><span class="fa fa-angle-down"></span></a></li>
							<li><a href="#" class="panel-remove"><span class="fa fa-times"></span></a></li>
		...
		<div class="col-md-6">
			...
			<form class="form-horizontal" name="pindelete" id="pindelete" method="post" onsubmit="return DeletePin()">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title"><strong>Hapus Pin </strong> Pendaftaran</h3>
						<ul class="panel-controls">
							<li><a href="#" class="panel-fullscreen"><span class="fa fa-expand"></span></a></li>
							<li><a href="#" class="panel-collapse"><span class="fa fa-angle-down"></span></a></li>
							<li><a href="#" class="panel-remove"><span class="fa fa-times"></span></a></li>
