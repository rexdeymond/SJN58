				...
				<div class="panel-body">                                                                        
					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<div class="row">
								<div class="form-group">
									<label class="col-md-4 control-label">Status Penarikan</label>
									<div class="col-md-8">                                            
										<div class="input-group">
											<span class="input-group-addon"><span class="fa fa-home"></span></span>
										...
										<span class="help-block">Status penarikan dana</span>
									</div>
								</div>
							</div>
				...
				<table id="TabelLaporan" class="table datatable table-striped table-hover dt-responsive display nowrap">
					<thead>
						<tr>
							...
							<th align="center" width="100px">NOID</th>
							<th align="right" width="150px">Nama</th>
							<th align="center" width="100px">Bank</th>
