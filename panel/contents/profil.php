<?php 
$sqlprf="SELECT *,concat(fnGetMemberJarUpline(noid,1,0), ' - ',fnGetMemberNama(fnGetMemberJarUpline(noid,1,0)), ' (',fnGetMemberTelp(fnGetMemberJarUpline(noid,1,0)),')') upline,
concat(fnGetMemberJarSponsor(noid,1), ' - ',fnGetMemberNama(fnGetMemberJarSponsor(noid,1)), ' (',fnGetMemberTelp(fnGetMemberJarSponsor(noid,1)),')') sponsor,concat(fnGetMemberPresenter(noid), ' - ',fnGetMemberNama(fnGetMemberPresenter(noid)), ' (',fnGetMemberTelp(fnGetMemberPresenter(noid)),')') presenter 
 from member where noid='".$unoid."' ";
 						...
 						<select class="form-control select" name="slcbank" id="slcbank" >
							...
							?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" style="color: black;" class="form-control" name="txtupl" readonly value="<?=$rsprf['noid']!=""?$rsprf['upline']:""?>"/>
                                                    </div>                                            
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" style="color: black;" class="form-control" name="txtspon" readonly value="<?=$rsprf['noid']!=""?$rsprf['sponsor']:""?>"/>
                                                    </div>                                            
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-volume-up"></span></span>
                                                        <input type="text" style="color: black;" class="form-control" name="txtpres" readonly value="<?=$rsprf['noid']!=""?$rsprf['presenter']:""?>"/>
                                                    </div>                                            
                                                    <span class="help-block">Anggota yang mem-presentasikan bisnis ini kepada Anda</span>
                                                </div>
                                            </div>
