		...
		<form class="form-horizontal" name="lapdaftar" id="lapdaftar" method="post" onsubmit="return previewData()">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><strong>Agen yang berhak </strong> Re-Entry</h3>
...
<hr/>
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><strong>Data </strong> Agen valid</h3>
				<ul class="panel-controls">
					<li><a href="#" class="panel-fullscreen"><span class="fa fa-expand"></span></a></li>
			...
			<div class="panel-body">                                                                        
				...
				<table id="TabelLaporan" class="table datatable">
					<thead>
						<tr>
							...
							<th align="center" width="50px">Sponsored</th>
 						</tr>
					</thead>
