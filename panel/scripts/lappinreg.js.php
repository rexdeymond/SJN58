...
var    TabelLaporan = $('#TabelLaporan').DataTable(
		{
	        ajax			: 'jsonp.php?t=pinroreg&l='+$("input[name=txtlimit]").val()+"&dateFrom="+$("input[name=txtDateFrom]").val()+"&dateTo="+$("input[name=txtDateTo]").val()+"&tp=REG&nostok="+$("select[name=slcnostok]").val()+"&kdbrg="+$("select[name=slcproduk]").val()+"&status="+$("select[name=slcstatus]").val(),
	        processing		: true,
				"scrollCollapse": true,
				"pageResize": true,
				autoWidth: false,
...
{
	url = "jsonp.php?t=pinroreg&l="+$("input[name=txtlimit]").val()+"&dateFrom="+$("input[name=txtDateFrom]").val()+"&dateTo="+$("input[name=txtDateTo]").val()+"&tp=REG&nostok="+$("select[name=slcnostok]").val()+"&kdbrg="+$("select[name=slcproduk]").val()+"&status="+$("select[name=slcstatus]").val();
