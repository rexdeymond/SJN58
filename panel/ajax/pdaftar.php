...
?>
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><strong>Pin </strong>Pendaftaran</h3>
				...
				<div class="panel-body table-responsive">                                                                        
						<table class="table table-bordered table-striped" id="TableBonus">
							<thead>
								<tr>
							...
							<tbody>
								<?php
								$sql = "SELECT pin.kodepin AS pin, pin.publik AS sts, stokist.nama AS stok 
										FROM pin 
										JOIN produk ON pin.kdbrg = produk.kdbrg AND produk.publik = '1'
										JOIN stokist ON pin.nostok = stokist.nostok 
										WHERE pin.kdbrg='REG' AND pin.publik = '1' AND ownedby = ? ORDER BY pin.created ASC";
