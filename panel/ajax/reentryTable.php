			<div class="panel panel-default">
				...
				<div class="panel-body">                                                                        
					...
					<table class="table table-striped table-hover" id="TableReEntry">
						...
						<tbody>
						<?php
$sql="SELECT noid,fnGetMemberNama(noid) nama,tanggal,ref,fnGetMemberNama(ref) namaref,bonus,fnGetAgenKodeLvl2(noid) kodelvl FROM `breentry` where noid='".$_SESSION['sjn58']."'";
